        ...
        {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="col-11" style="margin-left: 11%;">
              ...
              <input type="text" name="nom" v-model="cv.nom" id="inp2" class="na col-8" placeholder="Saisie votre nom">
              ...
              <textarea  type="text" name="description" v-model="cv.description" rows="1" id="inp3" style="margin-bottom:-15px;" class="na col-md-9" placeholder="Etudiant,Developpeur,Administrateur.."></textarea>
              <div class="lineee"></div>
          ...
          <div class="row">
            ...
            <div class="col-md-1"></div>
              ...
              <div class="col-md-5">
                ...
                <input type="text" name="ville" v-model="cv.ville" id="inp4" class="na col-5" placeholder="Rue,ville,pays">
                <div class="line"></div>
