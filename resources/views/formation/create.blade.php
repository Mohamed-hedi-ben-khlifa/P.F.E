...
<span class="catt" style="margin-left: 3%;">Formation profitionnelle</span>
      ...
      <form  action="{{url('cvs/'.$cv->id.'/formations')}}" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-10" style="margin-left: 12%;">
            ...
            <textarea type="text"  rows="1" name="description" style="margin-bottom:-1.5%;" id="inp2" class="col-md-10 na"
                 placeholder="La formation du candidat et sa motivation sont deux éléments cls sur lesquels le jury va porter son appréciation.
      ...
      <div class="col-md-12" style="text-align:right ">
        <a href="#" class="btn btn-dark col-md-3 m-1 mr-5 mt-5" @click="addformation"> + Formation</a>
